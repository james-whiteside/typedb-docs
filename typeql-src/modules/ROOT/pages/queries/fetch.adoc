...
:page-aliases: {page-component-version}@typeql::data/fetch.adoc
...
xref:{page-component-version}@typeql::modifiers/pagination.adoc[pagination] with a Fetch query.

Fetch queries can use rule-based xref:{page-component-version}@manual::reading/infer.adoc[inference].
...
To fetch a value, you can either fetch a xref:{page-component-version}@typeql::concepts/concept-variables.adoc[concept variable]
with an attribute, or fetch a xref:{page-component-version}@typeql::values/value-variables.adoc[value variable].
...
xref:{page-component-version}@typeql::statements/isa.adoc[isa] or xref:{page-component-version}@typeql::statements/sub.adoc[sub] statement.
...
xref:{page-component-version}@typeql::queries/get.adoc[Get query] with
xref:{page-component-version}@typeql::modifiers/aggregation.adoc[aggregation] that returns a value.
...
You can use xref:{page-component-version}@typeql::queries/get.adoc[Get] queries as subqueries as long as you use
xref:{page-component-version}@typeql::queries/get.adoc#_aggregation[aggregation] to get a value.
...
xref:{page-component-version}@manual::reading/infer.adoc#_how_to_send_a_query_with_inference[enabled].
...
xref:{page-component-version}@typeql::modifiers/aggregation.adoc[aggregation modifier].
