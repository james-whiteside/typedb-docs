...
:page-aliases: {page-component-version}@typeql::data/update.adoc
...
see the xref:{page-component-version}@manual::writing/update.adoc[] page of the TypeDB Manual.
...
xref:{page-component-version}@typeql::statements/role-assignment.adoc[role assignment], and
xref:{page-component-version}@typeql::statements/value-assignment.adoc[value assignment].
...
see the xref:{page-component-version}@typeql::queries/delete.adoc[] and xref:{page-component-version}@typeql::queries/insert.adoc[] page.
...
consider specifying xref:{page-component-version}@typeql::statements/unique.adoc[uniqueness annotation]
