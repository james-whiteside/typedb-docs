...
:page-aliases: {page-component-version}@typeql::schema/undefine.adoc
...
and annotations: xref:{page-component-version}@typeql::statements/key.adoc[] and xref:{page-component-version}@typeql::statements/unique.adoc[]. Schema statements in a `undefine` clause can't use any variables or values, except for xref:{page-component-version}@typeql::statements/rule.adoc[rules].
// end::syntax[]
